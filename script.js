...
function update() {
    ...
    for(let i = 0 ; i < boxesArray.length ; i++ ) {
        ...
        if(onCollision(player,box)) {
            ...
            if (lives > 0) {
                context.fillText("เอ๋อจัด", boardWidth / 2, boardHeight / 2 - 20);
                ...
                context.font = "bold 25px Arial";
                context.fillText("ไม่ไหวแล้วน่อง ' พอแล้ว ' ", boardWidth / 2, boardHeight / 2 + 20);
    ...
    if (time >= 60) {
        ...
        context.font = "bold 40px Arial";
        context.textAlign = "center";
        context.fillText("เวลาหมดนะน้องง", boardWidth / 2, boardHeight / 2);
